...
# -------------------------------------------------------
# CREATE TABLE in catalog.matchstream schema silver
# -------------------------------------------------------

spark.sql("""
CREATE TABLE matchstream.silver.test_iceberg_table (
    id BIGINT,
    name STRING,
    created_at TIMESTAMP
)
USING iceberg
LOCATION 's3a://matchstream/silver/test_iceberg_table'
""")

print("✓ Created table matchstream.silver.test_iceberg_table")
...
spark.sql("""
INSERT INTO matchstream.silver.test_iceberg_table VALUES
...
df = spark.sql("SELECT * FROM matchstream.silver.test_iceberg_table")
df.show()